...
def attack(char_name: str, char_class: str) -> str:
    """Apply attack method for each class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Apply defence method for each class."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не блокировал специальное урон')


def special(char_name: str, char_class: str) -> str:
    """Apply special skill method for each class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Check the char class and start training."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Define and confirm a char class."""
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> None:
    """Enter the program.
    Choose a name and a char class,
